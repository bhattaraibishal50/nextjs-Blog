...
{/* JSX styled */}
{/* Next.js has built-in support for styled-jsx, .css and .scss files., but you can also use other popular CSS-in-JS libraries such as styled-components or emotion. */}
    <style jsx>{`
      .hero {
        width: 100%;
        color: #333;
